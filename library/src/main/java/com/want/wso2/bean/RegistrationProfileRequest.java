 ...
 */
public class RegistrationProfileRequest extends Bean{
    ...
    public String toString() {
        return "RegistrationProfileRequest{" +
               "applicationName='" + applicationName + '\'' +
               ", tags=" + Arrays.toString(tags) +
               ", isAllowedToAllDomains=" + isAllowedToAllDomains +
               ", consumerKey='" + consumerKey + '\'' +
               ", consumerSecret='" + consumerSecret + '\'' +
               ", isMappingAnExistingOAuthApp=" + isMappingAnExistingOAuthApp +
               '}';
    }
}